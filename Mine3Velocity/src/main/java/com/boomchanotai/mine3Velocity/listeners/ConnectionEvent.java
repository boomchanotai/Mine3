package com.boomchanotai.mine3Velocity.listeners;
...
public class ConnectionEvent {
    ...
    public void onDisconnect(DisconnectEvent event) {
        ...
        if (address == null) {
            Logger.warning("Can't derive address from player", player.getUniqueId().toString(), player.getUsername());
            return;
        }

        PlayerRepository.removePlayer(address);
    }
}
