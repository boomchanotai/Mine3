...
public class PostgresRepository {
    public static void createNewPlayer(String address, double last_location_x, double last_location_y, double last_location_z, float last_location_yaw, float last_location_pitch, String  last_location_world) {
        try {
            PreparedStatement preparedStatement = Database.getConnection().prepareStatement("INSERT INTO users(address, is_logged_in, last_location_x, last_location_y, last_location_z, last_location_yaw, last_location_pitch, last_location_world) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
