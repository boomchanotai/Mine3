...
public class Config {
    ...
    public static int AUTH_AUTO_LOGIN_TIMEOUT;
    public static String AUTH_TOKEN_PREFIX_KEY;
    public static String AUTH_PLAYER_PREFIX_KEY;
    ...
    public static void loadConfig() {
        ...
        AUTH_AUTO_LOGIN_TIMEOUT = config.getInt("auth.auto_login_timeout");
        AUTH_TOKEN_PREFIX_KEY = config.getString("auth.token_prefix_key");
        AUTH_PLAYER_PREFIX_KEY = config.getString("auth.player_prefix_key");
